...
# ── Setup ──────────────────────────────────────────────────
setup() {
    header "Setting up Excel Model Eval"
...
# ── Streamlit App ──────────────────────────────────────────
run_app() {
    header "Launching Excel Model Eval (Streamlit)"
    ...
    echo ""
    "${VENV_DIR}/bin/streamlit" run "${REPO_DIR}/app.py"
}

# ── CLI Mode ───────────────────────────────────────────────
run_cli() {
    header "Running Excel Model Eval (CLI)"
...
COMMANDS
    ...
    app         Launch Streamlit UI only (skip setup)
    cli         Run CLI mode (python main.py)
